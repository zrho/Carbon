...
#define MEMORY_BOOT_INFO_VADDR    (MEMORY_SPACE_RECURSIVE_VADDR - 0x1000)
#define MEMORY_VIDEO_VADDR        (MEMORY_SPACE_RECURSIVE_VADDR - 0x2000)
#define MEMORY_GDT64_VADDR        (MEMORY_SPACE_RECURSIVE_VADDR - 0x3000)
#define MEMORY_LAPIC_VADDR        (MEMORY_SPACE_RECURSIVE_VADDR - 0x4000)
#define MEMORY_SPACE_HELPER_VADDR (MEMORY_SPACE_RECURSIVE_VADDR - 0x5000)
