...
// TODO: This file is copied from the kernel source. Find a better solution for
//       this, without creating a dependence beween the loader and the kernel
//       source.
...
uint64_t binary_load_elf64(void *binary, uint16_t pflags) {
    ...
    for (i = 0; i < header->e_phnum; ++i) {
        ...
        if (PT_LOAD == segment->p_type) {
            ...
            uint64_t target = physical;  // <-- Physical Addressing!
